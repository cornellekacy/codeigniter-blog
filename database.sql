...
INSERT INTO `comments` (`comment_id`,`user_id`, `status`, `post_id`,`fullname`,`email`, `comment`, `date_added`) VALUES
(2,1, 'approved', 10,'cornellekacy','cornellekacy@gmail.com', 'Hi, this is a comment. Thanks for this nice post. I like to see you blog. ', '2014-08-26 15:38:00'),
(3,2, 'unapproved', 10,'kuetecornelle','kuetecornelle@gmail.com', 'Oh, thanks for reading this blog. Thanks for being with me.', '2014-08-26 15:39:05');
...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  `post_tag` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `post_cat` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
